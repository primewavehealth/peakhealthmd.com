   ...
   <div className="container px-5 py-10 mx-auto">
    <div className="flex flex-col w-full mb-20 text-center">
     ...
     <p className="mx-auto text-base leading-relaxed text-gray-500 lg:w-2/3">
      We have different erectile dysfunction treatment options
     </p>
    </div>
    <div className="flex flex-wrap -m-4">
     <div className="w-full p-4 xl:w-1/4 md:w-1/2">
      <div className="relative flex flex-col h-full p-6 overflow-hidden border-2 border-green-500 rounded-lg">
       <strong className="pb-4 mb-4 text-5xl leading-none text-gray-900 border-b border-gray-200">
        PLATINUM PACKAGE
       </strong>
       <p className="pb-3 mt-3 text-xs text-gray-500">package includes:</p>
       <p className="flex items-center mb-2 text-gray-600">
        ...
        10 SHOCKWAVE THERAPY TREATMENTS
       </p>
       <p className="flex items-center mb-2 text-gray-600">
        <span className="inline-flex items-center justify-center flex-shrink-0 w-4 h-4 mr-2 text-white bg-gray-400 rounded-full">
         <svg
     ...
     <div className="w-full p-4 xl:w-1/4 md:w-1/2">
      <div className="relative flex flex-col h-full p-6 overflow-hidden border-2 border-indigo-500 rounded-lg">
       ...
       <strong className="flex items-center pb-4 mb-4 text-5xl leading-none text-gray-900 border-b border-gray-200">
        GOLD PACKAGE
       </strong>
       <p className="pb-3 mt-3 text-xs text-gray-500">package includes:</p>
       <p className="flex items-center mb-2 text-gray-600">
        ...
        8 SHOCKWAVE THERAPY TREATMENTS
       </p>
       <p className="flex items-center mb-2 text-gray-600">
        <span className="inline-flex items-center justify-center flex-shrink-0 w-4 h-4 mr-2 text-white bg-gray-400 rounded-full">
         <svg
     ...
     <div className="w-full p-4 xl:w-1/4 md:w-1/2">
      <div className="relative flex flex-col h-full p-6 overflow-hidden border-2 border-orange-600 rounded-lg">
       <strong className="flex items-center pb-4 mb-4 text-5xl leading-none text-gray-900 border-b border-gray-200">
       ...
       <p className="flex items-center mb-2 text-gray-600">
        ...
        6 SHOCKWAVE THERAPY TREATMENTS
       </p>
       <p className="flex items-center mb-2 text-gray-600">
        <span className="inline-flex items-center justify-center flex-shrink-0 w-4 h-4 mr-2 text-white bg-gray-400 rounded-full">
         <svg
     ...
     <div className="w-full p-4 xl:w-1/4 md:w-1/2">
      <div className="relative flex flex-col h-full p-6 overflow-hidden border-2 border-red-600 rounded-lg">
       <strong className="flex items-center pb-4 mb-4 text-5xl leading-none text-gray-900 border-b border-gray-200">
        BRONZE PACKAGE
       </strong>
       <p className="pb-3 mt-3 text-xs text-gray-500">package includes:</p>
       <p className="flex items-center mb-2 text-gray-600">
        ...
        3 SHOCKWAVE THERAPY TREATMENTS
       </p>
       <p className="flex items-center mb-2 text-gray-600">
        <span className="inline-flex items-center justify-center flex-shrink-0 w-4 h-4 mr-2 text-white bg-gray-400 rounded-full">
         <svg

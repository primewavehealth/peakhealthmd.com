...
function page() {
 return (
  <article className="prose">
   ...
   <br /> Welcome to the Vegas Clinic service website. The following terms and
   ...
   <br />
   2. Medical Information Disclaimer <br />
   ...
   condition. We do not endorse or recommend any specific tests, physicians,
   products, procedures, opinions, or other information that may be mentioned on
   our website.
   <br /> 3. User Accounts <br />
   ...
   laws. You may not reproduce, modify, distribute, or otherwise use any content
   on our website without our prior written consent.
   <br /> 6. Links to Third-Party Websites
   <br />
   <br /> Our website may contain links to third-party websites or resources. We
   do not endorse or assume any responsibility for any third-party content,
   ...
   website and supersede all prior agreements or understandings, whether written
   or oral, relating to your use of our website or any content, products, or
   services provided by us. If you have any questions or concerns about these
   Terms, please contact us <Link href="/contact">here</Link>.
  </article>
 );
}

...
export default function SearchArticles({
 ...
 return (
  <div className="container px-8 mx-auto ">
   ...
   <div className="py-12 md:border-l md:border-zinc-100 md:pl-6 md:dark:border-zinc-700/40">
   ...
   {totalArticles === 0 && (
    <div className="grid max-w-3xl space-y-16 content-center h-[20vh] mb-12">
     <div className="text-center">
      <NoSymbolIcon className="w-20 h-20 mx-auto text-gray-500 dark:text-gray-400" />
